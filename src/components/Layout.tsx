...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  return <div className="min-h-screen bg-white text-neutral-950 transition-colors dark:bg-neutral-950 dark:text-neutral-100">
    ...
    <footer className="mx-auto flex max-w-3xl justify-between border-t border-neutral-200 px-6 py-7 text-xs text-neutral-500 dark:border-neutral-800 sm:px-8"><span>You made it to the bottom.</span><span>© {new Date().getFullYear()} Venkat</span></footer>
  </div>
}
