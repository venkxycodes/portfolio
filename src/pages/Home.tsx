...
export default function Home() {
  return <div className="pt-16 sm:pt-24">
    ...
    <Section title="A little more"><p className="max-w-xl text-sm leading-7 text-neutral-600 dark:text-neutral-300">{siteContent.homeNote}</p><p className="mt-4 text-sm">Glad you are here! Feel free to reach out to me via the links below.</p></Section>
